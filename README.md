...
- **Reading**: open PDFs, extract/delete/rotate/reorder/merge pages, crop (set CropBox) and scale/resize pages, text extraction (plain or layout-preserving), AcroForm form fill/flatten, PDF stamping, watermarks, annotations, page numbers, file attachments, content overlay, AES-128/256 encryption and decryption.
